...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        reactScript.src = '<?php echo $CLIENT_ROOT; ?>/neon-react/static/js/main.06177728.js';
